...
# (str) Package name
package.name = knighteen

# (str) Package domain (needed for android/ios packaging)
package.domain = com.asacchetti
...
#[app:android.meta_data]
#com.google.android.gms.version = @integer/google_play_services_version
#com.google.android.gms.games.APP_ID = @string/public_version
#com.google.android.gms.appstate.APP_ID = @string/public_version
